...
raw_dataset=pd.read_csv('..\data\Canada10aug.csv',names=column_names,na_values="?",comment='\t',sep=",",skipinitialspace=True)
...
t = u"\u00b0"
print(' ',end='')
print("Testing set Mean Abs Error for Canada, 10 inputs: {:5.2f}".format(mae)+t+"C" )
