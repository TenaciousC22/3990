...
def popframes():
	...
	train_stats.pop('MarTemOut')
	train_stats.pop('MarPreOut')
	train_stats.pop('AprTemOut')
	train_stats.pop('AprPreOut')
	train_stats.pop('MayTemOut')
	train_stats.pop('MayPreOut')
	train_stats.pop('JunTemOut')
	train_stats.pop('JunPreOut')
	train_stats.pop('JulTemOut')
	train_stats.pop('JulPreOut')
	train_stats.pop('AugTemOut')
	train_stats.pop('AugPreOut')
	train_stats.pop('SepTemOut')
	train_stats.pop('SepPreOut')
	train_stats.pop('OctTemOut')
	train_stats.pop('OctPreOut')
	train_stats.pop('NovTemOut')
	train_stats.pop('NovPreOut')
	train_stats.pop('DecTemOut')
	train_stats.pop('DecPreOut')
...
def makelabels():
	...
	train_labels.join(train_dataset.pop('JanPreOut'))
